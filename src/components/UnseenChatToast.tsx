...
export default function UnseenChatToast({ t, senderId, sessionId, senderImg, senderName, senderMessage }: UnseenChatToast) {
  return <div
  ...
  >
    <a
      onClick={() => toast.dismiss(t.id)} href={`/dashboard/chat/${chatHrefConstructor(sessionId, senderId)}`}
    ...
    <div className="flex border-l broder-gray-200">
      <button
